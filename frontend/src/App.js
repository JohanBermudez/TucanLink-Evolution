    ...
    const theme = createTheme(
        {
            scrollbarStyles: {
                ...
                "&::-webkit-scrollbar-thumb": {
                    backgroundColor: mode === "light" ? "rgba(232, 50, 70, 0.3)" : "rgba(232, 50, 70, 0.4)",
                    borderRadius: '3px',
                    '&:hover': {
                        backgroundColor: mode === "light" ? "rgba(232, 50, 70, 0.5)" : "rgba(232, 50, 70, 0.6)",
                    },
                },
            },
            scrollbarStylesSoft: {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#e83246" : "#FFFFFF" },
                textPrimary: mode === "light" ? "#e83246" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#e83246" : "#FFFFFF",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #e83246, #e83246 , #e83246)" : "#666",
