...
import { AccountTree, AllInclusive, AttachFile, BlurCircular, Chat, DeviceHubOutlined, Schedule, SettingsEthernet } from '@material-ui/icons';
...
const useStyles = makeStyles((theme) => ({
  ListSubheader: {
    ...
    color: theme.mode === 'light' ? '#9e9e9e' : '#757575',
  ...
  listItem: {
    ...
    '&:hover': {
      backgroundColor: theme.mode === 'light' ? 'rgba(232, 50, 70, 0.08)' : 'rgba(232, 50, 70, 0.15)',
      transform: 'translateX(2px)',
    },
    '&.Mui-selected': {
      backgroundColor: theme.mode === 'light' ? 'rgba(232, 50, 70, 0.12)' : 'rgba(232, 50, 70, 0.25)',
      '&:hover': {
        backgroundColor: theme.mode === 'light' ? 'rgba(232, 50, 70, 0.15)' : 'rgba(232, 50, 70, 0.3)',
      },
    },
  },
  listItemIcon: {
  ...
  listItemText: {
    '& .MuiListItemText-primary': {
      fontSize: '0.9rem',
      fontWeight: 500,
      color: theme.mode === 'light' ? '#333' : '#e0e0e0',
    },
  },
  divider: {
    margin: '12px 0',
  ...
  return (
    <li style={{ listStyle: 'none' }}>
      <ListItem 
        ...
        title={primary} // Tooltip cuando está cerrado
      >
          ...
          <>
            ...
            {showCampaigns && (
              <>
                <ListItem
                  ...
                  style={{ margin: '2px 8px', borderRadius: '8px', padding: '8px 12px' }}
                >
                  ...
                  />
                  {openCampaignSubmenu ? (
                    <ExpandLessIcon style={{ color: '#999' }} />
                  ) : (
                ...
                >
                  <List component="div" disablePadding>
                    ...
                    >
                      <ListItemIcon style={{ minWidth: '35px', color: '#999' }}>
            ...
            {showIntegrations && (
              <>
                ...
                <ListItemLink
                  to="/webhook-config"
                  primary="Configuración Webhooks"
