    ...
    const delayDebounceFn = setTimeout(() => {
      const fetchTicket = async () => {
        try {
          ...
          const hasQueuePermission = queues.find((q) => q.id === queueId);
          const isTicketWithoutQueue = queueId === null || queueId === undefined;
          const canViewTicketsWithoutQueue = allTicket === "enabled";

          const hasAccess = isAdmin || 
                           hasQueuePermission || 
                           (isTicketWithoutQueue && canViewTicketsWithoutQueue);
