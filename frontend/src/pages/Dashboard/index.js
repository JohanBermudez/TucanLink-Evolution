...
const useStyles = makeStyles((theme) => ({
  ...
  card1: {
    ...
    height: "100%",
    background: "#ffffff",
    border: "1px solid rgba(232, 50, 70, 0.1)",
    color: "#e83246",
    borderRadius: 16,
    ...
    "&:hover": {
      ...
      boxShadow: "0 4px 16px rgba(232, 50, 70, 0.15)",
      borderColor: "rgba(232, 50, 70, 0.2)",
    },
  },
  card2: {
    padding: theme.spacing(3),
    ...
    height: "100%",
    background: "#fef5f6",
    border: "1px solid rgba(232, 50, 70, 0.08)",
    color: "#333333",
    borderRadius: 16,
    boxShadow: "0 2px 8px rgba(0, 0, 0, 0.04)",
    transition: "all 0.3s ease",
    "&:hover": {
      transform: "translateY(-2px)",
      boxShadow: "0 4px 16px rgba(232, 50, 70, 0.12)",
      borderColor: "rgba(232, 50, 70, 0.15)",
    },
  },
  card3: {
    padding: theme.spacing(3),
    ...
    "&:hover": {
      transform: "translateY(-2px)",
      boxShadow: "0 4px 16px rgba(66, 153, 225, 0.15)",
